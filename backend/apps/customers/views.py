"""REST views for customer attachments."""
...
from .models import CustomerAttachment


@method_decorator(csrf_exempt, name="dispatch")
class CustomerAttachmentDownloadView(View):
    """REST endpoint for downloading customer attachments."""
