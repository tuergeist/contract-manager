...
def log_invoice_created(record) -> AuditLog | None:
...
def log_invoice_email_sent(record, recipients: list[str]) -> AuditLog | None:
...
def log_invoice_voided(record) -> AuditLog | None:
