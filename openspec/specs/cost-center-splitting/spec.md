...
The system SHALL allow users to define rules that automatically split transactions or incoming invoices across multiple cost centers. Rules are defined per counterparty or per booking text pattern.
...
- **WHEN** user creates a split rule with 60% to "100" and 30% to "200" (totaling 90%)
