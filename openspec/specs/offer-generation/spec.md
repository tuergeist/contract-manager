...
Generate sales offers from contract billing events. Snapshots line items, company data, and contract terms (minimum term, notice period) at create time, assigns a sequential offer number, and renders the PDF the customer will see.
## Requirements
